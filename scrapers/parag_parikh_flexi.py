...
response = app.scrape_url(url='https://www.moneycontrol.com/mutual-funds/parag-parikh-flexi-cap-fund-direct-plan/portfolio-holdings/MPP002', params={
	'formats': [ 'markdown' ],
})
...
with open('cleaned_holding_data_pp_flexi.json', 'w') as f:
