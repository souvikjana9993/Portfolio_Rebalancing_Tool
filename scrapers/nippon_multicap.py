...
response = app.scrape_url(url='https://www.moneycontrol.com/mutual-funds/nippon-india-multi-cap-fund-direct-plan/portfolio-holdings/MRC914', params={
	'formats': [ 'markdown' ],
})
...
with open('cleaned_holding_data_nippon.json', 'w') as f:
